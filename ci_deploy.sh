...
if [ "$BUILD_TYPE" == "default" ]; then
    ...
    cp bindings/jni/android/zmosq-android.jar zmosq-android-0.1.0.jar
    export ZMOSQ_DEPLOYMENT=zmosq-android-0.1.0.jar
else
    export ZMOSQ_DEPLOYMENT=""
fi
